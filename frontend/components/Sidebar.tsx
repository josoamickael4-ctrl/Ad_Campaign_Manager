            ...
            <div className="flex-1 space-y-8">
                <div>
                    ...
                    <nav className="space-y-1.5">
                        ...
                        <Link
                            href="/campaigns/new"
                            className={`flex items-center justify-start px-4 py-2.5 rounded-[10px] text-[15px] font-medium transition-all duration-200 group ${isActive('/campaigns/new')
                                ? 'bg-[#e8e8ed] text-[#1d1d1f]'
                                : 'text-[#525255] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'
                                }`}
                        >
                            <svg className={`w-[20px] h-[20px] mr-3 flex-shrink-0 ${isActive('/campaigns/new') ? 'text-[#1d1d1f]' : 'text-[#86868b] group-hover:text-[#525255]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
